 	...
 	<nav class="navbar-dark bg-danger sticky-bottom">
 		...
 		<div class="container-fluid row">
 			<div class="col-md-4 text-left" style="color:#F8F8FF;">
				<p>Official Facebook Page<br><a href="#" class="nav-item">facebook.com/jofbrokerage</a></p>
				<p>Contact<br> +63 975 380 3360</p>
			</div>

			<div class="col-md-4 text-center" style="color:#F8F8FF;">
				<h3>Copyright @ Team JOF 2019</h3>
			</div>

			<div class="col-md-4 text-right">
 				<h3 style="color:#F8F8FF;" class="display-6">Business Hours</h3>
				<p style="color:#F8F8FF;">Monday to Friday <br> 9:00 AM to 5:00 PM</p>
			</div>
