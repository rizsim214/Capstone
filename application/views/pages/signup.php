                 ...
                 <div class="form-row">
                      <div class="form-group col-md-6">
                        <label for="inputComName">Company Name</label>
                         <input type="text" class="form-control <?php echo form_error('companyName') ? 'is-invalid' : '';?> " id="inputComName" name="companyName" value="<?php echo isset($companyName) ? $companyName : '' ?>" placeholder="Company Name">
                         <div class="invalid-feedback" ><?php echo form_error('companyName') ? form_error('companyName') : '';?></div>
                </div>
                <div class="form-group col-md-6">
                       <label for="inputComAdd">Company Address</label>
                          <input type="text" class="form-control <?php echo form_error('companyAdd') ? 'is-invalid' : '';?>" id="inputComAdd" name="companyAdd" value="<?php echo isset($companyAdd) ? $companyAdd : '' ?>" placeholder="Company Address">
                           <div class="invalid-feedback" ><?php echo form_error('companyAdd') ? form_error('companyAdd') : '';?></div>
                          </div>
                </div>
                <div class="form-row">
                      <div class="form-group col-md-6">
